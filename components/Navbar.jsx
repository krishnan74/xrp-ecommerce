  ...
  return (
    <div className='flex justify-evenly items-center fixed w-full border-b-2 h-17 py-3 z-30 bg-white'>
      <h1>XRP - ECommerce</h1>
          ...
          <button onClick={toggleConnectDiv} className={buttonVariants({ variant: "outline" })}>Connect Wallet</button>
        ...
        <div className="bg-white p-6 rounded-md space-y-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              <button onClick={connectWallet} className="mt-3 w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-300">
                Connect Wallet
              </button>
            </div>
            {/* Create Account Side */}
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-400"
              />
              <button onClick={createNewWallet} className="mt-3 w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition duration-300">
                Create Wallet
              </button>
            </div>
          </div>
          <button onClick={toggleConnectDiv} className="flex items-center justify-center w-full bg-gray-200 text-gray-600 py-2 rounded-md hover:bg-gray-300 transition duration-300">
